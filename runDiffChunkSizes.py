...
def popenAndCall(bench, workload, inits, opers, msize, threads, opt, split, serial):
    ...
    try:
        ...
        subprocess.call("tar -C "+piwiDataDir+" -xzf "+dbPath+"/savedb.tar.gz", shell=True)
...
piwi_commonOps = ''
keyrange = '15000000'
munk_sizes = ['196608', '40330', '20166', '2522'] #5MB, 1MB, 500KB, 64KB 
...
piwi_options = ['-maxMunks 32768 -writeBufBytesCapacity 524288 -initChunks 500000 -use_existing_db true'] 
