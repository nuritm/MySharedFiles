...
#                sys.stdout.buffer.write(line) # pass bytes as is
    ...
    if not os.path.exists(dbPath):
        os.makedirs(dbPath)
    subprocess.call("tar -C "+ piwiDataDir+"/ -cvzf " + dbPath + "/savedDb.tar.gz .", shell=True)
#    subprocess.call("rsync -a " + piwiDataDir + "/ " + dbPath+ "/", shell=True)
    deleteFiles()
    return
...
initsNum = ['0']
opersNum = ['60000000']
piwi_options = ['-maxMunks 400 -writeBufBytesCapacity 524288 -initChunks 2']
